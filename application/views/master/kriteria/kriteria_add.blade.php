...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">Tambah Kriteria</header>
                <div class="panel-body">
                    <form method="post" class="form-horizontal" action="{{ site_url('kriteria/do_add') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="score" class="form-control" value="{{ set_value('score') }}">
