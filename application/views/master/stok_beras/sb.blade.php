                ...
                <table class="table table-striped table-advance table-hover">
                    ...
                    @if(!empty($sb))
                        ...
                        <tr>
                            ...
                            <td>{{ $item->tahun }}</td>
                            <td>{{ $item->jml_stock - $item->tambahan_stock }} Karung</td>
                            <td>{{ $item->tambahan_stock }} Karung</td>
                            <td>{{ $item->jml_stock }} Karung</td>
                            <td>{{ $item->stock_terpakai }} Karung</td>
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-primary" href="{{ site_url('stok_beras/view/'.$item->id_stok_beras) }}"><i class="icon_search"></i></a>
